...
namespace jQueryBuddy.CodeCompletion
{
    internal abstract class CodeCompletionBase
    {
        ...
        public event EventHandler<InstantHelpEventArgs> PreviewInstantHelp;
        internal void InvokePreviewInstantHelp(InstantHelpEventArgs e)
        {
            var handler = PreviewInstantHelp;

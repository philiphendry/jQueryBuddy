...
namespace jQueryBuddy.CodeCompletion.jQueryAPI
{
    public class Loader
    {
        public JQueryDocs LoadFromResource()
        {
            using (var manifestResourceStream = Assembly.GetExecutingAssembly().GetManifestResourceStream("jQueryBuddy.Resources.jQuery1.6.4_api.xml"))
            {
